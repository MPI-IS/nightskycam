...
def _get_config(
    target_dir: Path, active: _Active
) -> nightskycam.configuration_getter.ConfigurationGetter:
    ...
    return nightskycam.configuration_getter.DictConfigurationGetter(config)
